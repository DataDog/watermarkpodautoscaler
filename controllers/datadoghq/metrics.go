...
func cleanupAssociatedMetrics(wpa *datadoghqv1alpha1.WatermarkPodAutoscaler, onlyMetricsSpecific bool) {
	...
	if !onlyMetricsSpecific {
		...
		promLabelsInfo := prometheus.Labels{wpaNamePromLabel: wpa.Name, wpaNamespacePromLabel: wpa.Namespace, resourceNamespacePromLabel: wpa.Namespace, namespacePromLabel: wpa.Namespace, dryRunPromLabel: strconv.FormatBool(wpa.Spec.DryRun)}
