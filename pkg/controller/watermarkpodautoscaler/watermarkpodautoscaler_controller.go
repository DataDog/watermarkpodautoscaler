...
var log = logf.Log.WithName("controller_watermarkpodautoscaler")
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileWatermarkPodAutoscaler{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &datadoghqv1alpha1.WatermarkPodAutoscaler{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcileWatermarkPodAutoscaler) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set WatermarkPodAutoscaler instance as the owner and controller
...
func newPodForCR(cr *datadoghqv1alpha1.WatermarkPodAutoscaler) *corev1.Pod {
