...
cp $GIT_ROOT/hack/release/wpa-plugin-tmpl.yaml $OUTPUT_FOLDER/wpa-plugin.yaml

$SED "s/PLACEHOLDER_TAG/$TAG/g" $OUTPUT_FOLDER/wpa-plugin.yaml
$SED "s/PLACEHOLDER_VERSION/$VERSION/g" $OUTPUT_FOLDER/wpa-plugin.yaml
$SED "s/PLACEHOLDER_SHA_AMD_DARWIN/$DARWIN_AMD64/g" $OUTPUT_FOLDER/wpa-plugin.yaml
$SED "s/PLACEHOLDER_SHA_AMD_LINUX/$LINUX_AMD64/g" $OUTPUT_FOLDER/wpa-plugin.yaml
$SED "s/PLACEHOLDER_SHA_AMD_WINDOWS/$WINDOWS_AMD64/g" $OUTPUT_FOLDER/wpa-plugin.yaml
$SED "s/PLACEHOLDER_SHA_ARM_DARWIN/$DARWIN_ARM64/g" $OUTPUT_FOLDER/wpa-plugin.yaml
$SED "s/PLACEHOLDER_SHA_ARM_LINUX/$LINUX_ARMD64/g" $OUTPUT_FOLDER/wpa-plugin.yaml
$SED "s/PLACEHOLDER_SHA_ARM_WINDOWS/$WINDOWS_ARM64/g" $OUTPUT_FOLDER/wpa-plugin.yaml