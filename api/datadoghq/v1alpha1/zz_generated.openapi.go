...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"./api/datadoghq/v1alpha1.CrossVersionObjectReference":  schema__api_datadoghq_v1alpha1_CrossVersionObjectReference(ref),
		"./api/datadoghq/v1alpha1.ExternalMetricSource":         schema__api_datadoghq_v1alpha1_ExternalMetricSource(ref),
		"./api/datadoghq/v1alpha1.MetricSpec":                   schema__api_datadoghq_v1alpha1_MetricSpec(ref),
		"./api/datadoghq/v1alpha1.ResourceMetricSource":         schema__api_datadoghq_v1alpha1_ResourceMetricSource(ref),
		"./api/datadoghq/v1alpha1.WatermarkPodAutoscaler":       schema__api_datadoghq_v1alpha1_WatermarkPodAutoscaler(ref),
		"./api/datadoghq/v1alpha1.WatermarkPodAutoscalerSpec":   schema__api_datadoghq_v1alpha1_WatermarkPodAutoscalerSpec(ref),
		"./api/datadoghq/v1alpha1.WatermarkPodAutoscalerStatus": schema__api_datadoghq_v1alpha1_WatermarkPodAutoscalerStatus(ref),
	}
}

func schema__api_datadoghq_v1alpha1_CrossVersionObjectReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema__api_datadoghq_v1alpha1_ExternalMetricSource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema__api_datadoghq_v1alpha1_MetricSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"external": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("./api/datadoghq/v1alpha1.ExternalMetricSource"),
						},
					},
					"resource": {
						SchemaProps: spec.SchemaProps{
							Description: "resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \"pods\" source.",
							Ref:         ref("./api/datadoghq/v1alpha1.ResourceMetricSource"),
						},
					},
				},
		...
		Dependencies: []string{
			"./api/datadoghq/v1alpha1.ExternalMetricSource", "./api/datadoghq/v1alpha1.ResourceMetricSource"},
	}
}

func schema__api_datadoghq_v1alpha1_ResourceMetricSource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema__api_datadoghq_v1alpha1_WatermarkPodAutoscaler(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("./api/datadoghq/v1alpha1.WatermarkPodAutoscalerSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("./api/datadoghq/v1alpha1.WatermarkPodAutoscalerStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./api/datadoghq/v1alpha1.WatermarkPodAutoscalerSpec", "./api/datadoghq/v1alpha1.WatermarkPodAutoscalerStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema__api_datadoghq_v1alpha1_WatermarkPodAutoscalerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"scaleTargetRef": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("./api/datadoghq/v1alpha1.CrossVersionObjectReference"),
						},
					},
					"metrics": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("./api/datadoghq/v1alpha1.MetricSpec"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"./api/datadoghq/v1alpha1.CrossVersionObjectReference", "./api/datadoghq/v1alpha1.MetricSpec", "k8s.io/apimachinery/pkg/api/resource.Quantity"},
	}
}

func schema__api_datadoghq_v1alpha1_WatermarkPodAutoscalerStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
